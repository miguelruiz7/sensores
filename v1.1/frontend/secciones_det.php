    ...
    while($datos = mysqli_fetch_array($buscaSecciones)){
           ...
           <div class="row row-cols-1 row-cols-sm-2 row-cols-md-1 g-3">
            <!--   <div class="col text-center"><button class="btn"><h6 class="card-subtitle mb-2 text-body-secondary"><?php echo $i_placa; ?><span class="badge bg-secondary">0</span></h6></button></div>
              ...
              <div class="col text-center"><button class="btn"><h6 class="card-subtitle mb-2 text-body-secondary" onclick="cargarProductosSeccion('<?php echo $datos['sec_id']; ?>')"><?php echo $i_lista_prod; ?><span class="badge bg-secondary">0</span></h6></button></div>
            </div> 
