  ...
  <?php
    while($datosUsuarios = mysqli_fetch_array($buscaUsuarios)){
          ...
          <tr>
                ...
                <td><?php if($datosUsuarios['usr_defadmin'] == 1){echo 'Administrador por defecto';}else{echo 'Usuario';}?></td>
                <td><?php echo $datosUsuarios['usr_usu'];?></td>
                <td>
                    <button class="btn btn-outline-dark" onclick="contrasenaUsr();"><?php echo $i_modificar; ?></button>
                    <button class="btn btn-outline-dark" onclick="contrasenaUsr();"><?php echo $i_basura; ?></button>
                    <button class="btn btn-outline-dark" onclick="contrasenaUsr();"><?php echo $i_llave; ?></button>
                  </td>
                </tr>
            <?php
    }
